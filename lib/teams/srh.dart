              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/SRHbg.PNG"),
                    fit: BoxFit.cover
                  ),
                ),
                ...
                child: Row(
                  children: [
                    Image(
                      width: 100,
                      height: 100,
                      image: AssetImage("assets/Warner.PNG"),
                    ),
                    Container(margin: EdgeInsets.only(left: 12), child: Text("David Warner (C)",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    Image(
                      width: 100,
                      height: 100,
                      image: AssetImage("assets/Samad.PNG"),
                    ),
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Abdul Samad",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    Image(
                      width: 100,
                      height: 100,
                      image: AssetImage("assets/Abhishek.PNG"),
                    ),
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Abhishek Sharma",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(margin: EdgeInsets.only(left: 10),child: Text("MUMBAI INDIANS",style: mystyle(16,getteamcolor("SRH")),)),
