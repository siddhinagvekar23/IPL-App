              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/DCbg.PNG"),
                    fit: BoxFit.cover
                  ),
                ),
                ...
                child: Row(
                  children: [
                    Image(
                      width: 100,
                      height: 100,
                      image: AssetImage("assets/Shreyas.PNG"),
                    ),
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Shreyas Iyer (C)",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    Image(
                      width: 100,
                      height: 100,
                      image: AssetImage("assets/Ajinkya.PNG"),
                    ),
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Ajinkya Rahane",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Alex Carey",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(padding: EdgeInsets.all(8),child: Text("Tuesday, 10 November 2020",style: mystyle(16,Colors.orange[900]),)),
                                  ],
                                ),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(padding: EdgeInsets.all(8),child: Text("Tuesday, 8 November 2020",style: mystyle(16,Colors.orange[900]),)),
                                  ],
                                ),
                                ...
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.start,
                                  children: [
                                    Container(margin: EdgeInsets.only(left: 10),child: Text("Qualifier 2",style: mystyle(14,Colors.red),)),
                                ...
                                Container(child: Text("Delhi Capitals won by 17 runs",style: mystyle(13,Colors.black),)),
