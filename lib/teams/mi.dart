              ...
              Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: AssetImage("assets/MIbg.PNG"),
                    fit: BoxFit.cover
                  ),
                ),
                ...
                child: Row(
                  children: [
                    Image(
                      width: 100,
                      height: 100,
                      image: AssetImage("assets/Rohit.PNG"),
                    ),
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Rohit Sharma (C)",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Aditya Tare",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
                ...
                child: Row(
                  children: [
                    Image(
                      width: 100,
                      height: 100,
                      image: AssetImage("assets/Anmolpreet.PNG"),
                    ),
                    Container(margin: EdgeInsets.only(left: 12), child: Text("Anmolpreet Singh",style: mystyle(15,Colors.black),),),
                  ],
                ),
              ),
